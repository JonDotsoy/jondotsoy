...
import { setupToolExamples } from "./tools/examples.js";
import { z } from "zod";
...
// Configurar herramientas de ejemplo adicionales
setupToolExamples(server);

// Herramientas principales del tutorial
server.registerTool(
  "create-task",
  {
